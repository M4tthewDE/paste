...
func Index() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!doctype html><html><script src=\"https://unpkg.com/htmx.org@1.9.10\"></script><style type=\"text/css\">\n\t\t\t.textarea {\n\t\t\t\twidth: 99%;\n\t\t\t\theight: 100%;\n\t\t\t\tresize: none;\n\t\t\t}\n\n\t\t\t.container {\n\t\t\t\theight: 90vh;\n\t\t\t}\n\n\t\t\tinput {\n\t\t\t\tmargin-bottom: 10px;\n\t\t\t}\n\n\t\t\tform {\n\t\t\t\theight: 100%;\n\t\t\t}\n\t\t</style><div class=\"container\"><form hx-post=\"/upload/paste\" hx-swap=\"none\"><textarea placeholder=\"Your content goes here\" name=\"content\" class=\"textarea\" spellcheck=\"false\"></textarea> <input type=\"submit\" value=\"Submit\"></form></div><script>\n\t\t\thtmx.on(\"htmx:afterRequest\", function (evt) {\n\t\t\t\tif (evt.detail.successful) {\n\t\t\t\t\twindow.location.href = \"/\" + evt.detail.xhr.response\n\t\t\t\t}\n\t\t\t});\n\t\t</script></html>")
